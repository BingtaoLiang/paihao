(function () {
    var hintText = {
        ...
        user_name: {hint: "⚠️请输入3-12个字符的用户名（包括字母/数字/下划线）", right: "√姓名格式正确", wrong: "×姓名格式有误，请重新输入"},
        name: {hint: "⚠️请输入3-12姓名", right: "√姓名输入正确", wrong: "×姓名输入有误，请重新输入"},
        age: {hint: "⚠️请输入1-120年龄", right: "√年龄输入正确", wrong: "×年龄输入有误，请重新输入"},
        sex: {hint: "⚠️请填写“男”或“女”", right: "√性别输入正确", wrong: "×性别输入错误，请重新输入"},
